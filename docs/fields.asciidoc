...
| <<ecs-call_stack,Call Stack>> | TODO
...
| <<ecs-malware_classification,Malware Classification>> | These fields contain the malware classification.

| <<ecs-modules,Modules>> | These fields contain information about a list of modules.
